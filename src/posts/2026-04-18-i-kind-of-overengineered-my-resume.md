...
```
 Lume makes the contents of this file available as a variable from anywhere. A layout document, `src/_includes/layouts/resume.vto`, does just this. This layout is a [Vento template](https://vento.js.org/). The original `resume.md` now simply references the template, which uses the `resume` variable to build the HTML.
...
I can use the Lume archetype system to create variant versions of my 
résumé:
...
![Resume updated -- sync to LinkedIn](../img/resume-update.png)
...
Check out my résumé here: [/resume/](/resume/)

Here's an example variant: [/resume/acme-corp](/resume/acme-corp)

The source code for this site is here: [https://github.com/ajzeigert/zeigert.com](https://github.com/ajzeigert/zeigert.com)
